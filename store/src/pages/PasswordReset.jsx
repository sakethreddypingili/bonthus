  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userProfile.role === 'employee') {
        // Safe update via user profile or auth endpoint
      ...
      <div className="max-w-md w-full bg-white rounded-[32px] shadow-2xl border border-gray-100 overflow-hidden animate-in zoom-in duration-500">
        <div className="p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 pl-14 pr-12 text-[12px] font-black tracking-widest focus:outline-none focus:ring-2 focus:ring-black/5 focus:border-black focus:bg-white transition-all"
            ...
            {error && (
              <div className="p-4 bg-black text-white rounded-2xl text-[10px] font-black uppercase tracking-widest text-center shadow-lg animate-in slide-in-from-top-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 bg-black text-white rounded-[24px] text-[10px] font-black uppercase tracking-[0.3em] shadow-2xl hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-20 mt-4"
            >
