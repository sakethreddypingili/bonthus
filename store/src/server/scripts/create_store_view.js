...
const SQL = `
-- Create updatable store view pointing to stores
CREATE OR REPLACE VIEW public.store AS SELECT * FROM public.stores;
GRANT ALL ON public.store TO authenticated, service_role, anon, postgres;
...
async function upgrade() {
    ...
    try {
        ...
        console.log('✅ Database View store created successfully.');
    } catch (e) {
