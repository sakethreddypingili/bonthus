...
const SQL = fs.readFileSync(path.resolve(__dirname, 'drop_phone_unique.sql'), 'utf8');

async function upgrade() {
    console.log(`🔧 Connecting to Supabase database to drop unique constraint...`);
    ...
    try {
        ...
        console.log('✅ Unique phone constraint dropped successfully.');
    } catch (e) {
