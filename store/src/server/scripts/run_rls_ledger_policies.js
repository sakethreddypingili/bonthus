...
const SQL = fs.readFileSync(path.resolve(__dirname, 'rls_ledger_policies.sql'), 'utf8');

async function upgrade() {
    console.log(`🔧 Connecting to Supabase database to apply RLS ledger policies...`);
    ...
    try {
        ...
        console.log('✅ RLS Ledger policies applied successfully.');
    } catch (e) {
