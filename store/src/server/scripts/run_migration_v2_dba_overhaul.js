...
const SQL = fs.readFileSync(path.resolve(__dirname, 'migration_v2_dba_overhaul.sql'), 'utf8');

async function upgrade() {
    console.log(`🔧 Connecting to Supabase database to execute DBA overhaul migration...`);
    ...
    try {
        ...
        console.log('✅ DBA Overhaul migration completed successfully.');
    } catch (e) {
