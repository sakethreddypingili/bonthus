...
"absent":"bg-gray-200 text-gray-500 line-through px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider",
  ...
  return (
    <div className="space-y-8 animate-fast-slide">
      ...
      {notice.message && (
        <div className={`p-4 rounded-2xl border text-[10px] font-black uppercase tracking-widest flex items-center gap-3   ${notice.type ==="error" ?"bg-gray-100 text-black border-black" :"bg-black text-white border-black"}`}>
      ...
      <div className="bg-gray-50 p-1.5 rounded-2xl border border-gray-100 inline-flex w-full md:w-auto">
        {!isEmployee && (
          <button onClick={() => setActiveTab("employees")} className={`flex-1 md:flex-none px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest  ${activeTab ==="employees" ?"bg-black text-white shadow-lg" :"text-gray-400 hover:text-black"}`}>Staff</button>
        )}
        <button onClick={() => setActiveTab("scan")} className={`flex-1 md:flex-none px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest  ${activeTab ==="scan" ?"bg-black text-white shadow-lg" :"text-gray-400 hover:text-black"}`}>Scan</button>
        <button onClick={() => setActiveTab("history")} className={`flex-1 md:flex-none px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest  ${activeTab ==="history" ?"bg-black text-white shadow-lg" :"text-gray-400 hover:text-black"}`}>Ledger</button>
        {!isEmployee && (
          <button onClick={() => setActiveTab("qr")} className={`flex-1 md:flex-none px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest  ${activeTab ==="qr" ?"bg-black text-white shadow-lg" :"text-gray-400 hover:text-black"}`}>QR Gen</button>
        )}
      </div>
      ...
      {activeTab ==="history" && (
        <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-8 space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-6 text-center group hover:border-black">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 text-center hover:border-black">
      ...
      {activeTab ==="qr" && (
        <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-12 flex flex-col items-center max-w-xl mx-auto text-center">
          ...
          <div className="flex bg-gray-50 p-1.5 rounded-2xl border border-gray-100 w-full mb-8">
            <button onClick={() => setQrType("check_in")} className={`flex-1 py-3 text-[10px] font-black uppercase tracking-widest rounded-xl  ${qrType ==="check_in" ?"bg-black text-white shadow-lg" :"text-gray-400"}`}>Check In</button>
            <button onClick={() => setQrType("check_out")} className={`flex-1 py-3 text-[10px] font-black uppercase tracking-widest rounded-xl  ${qrType ==="check_out" ?"bg-black text-white shadow-lg" :"text-gray-400"}`}>Check Out</button>
          </div>

          <div className="p-8 bg-white border border-gray-100 rounded-[3rem] shadow-2xl">
            {generatedCode ? (
          ...
          <button onClick={handleGenerateQR} disabled={isGenerating || (isSuperAdmin && selectedStoreId ==="All")} className="w-full mt-12 bg-black text-white font-black py-5 rounded-[2rem] text-[11px] uppercase tracking-[0.2em] hover:shadow-2xl  disabled:opacity-50">
      ...
      {activeTab ==="scan" && (
        <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-12 flex flex-col items-center max-w-xl mx-auto text-center">
          ...
          <div className="relative w-full aspect-square bg-black rounded-[3rem] overflow-hidden shadow-2xl border-8 border-gray-50">
            ...
            {!isScanning && (
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                ...
                <button onClick={startCamera} disabled={isStartingScanner || !currentUserEmployee} className="px-8 py-3 bg-white text-black text-[10px] font-black uppercase tracking-widest rounded-2xl hover:shadow-xl  disabled:opacity-50">
          ...
          <div className="mt-12 p-6 bg-gray-50 border border-gray-100 rounded-[2rem] w-full flex items-center gap-4 text-left group hover:border-black">
