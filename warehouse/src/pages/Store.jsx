      ...
      >
        <div className="flex flex-col h-full space-y-8">
          ...
          <div className="pt-6 border-t border-gray-50 mt-auto flex items-center justify-end gap-4">
            <button onClick={() => setShowDetailModal(false)} className="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest hover:text-black">Discard</button>
            <button className="px-8 py-4 bg-black text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
